...
module.exports.WG_NETMARK =
  process.env.WG_NETMARK ||
  32 - Util.countOccurrences(module.exports.WG_DEFAULT_ADDRESS, "x") * 8;
...
module.exports.WG_POST_UP =
  ...
  `
iptables -t nat -A POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS.replaceAll(
    "x",
    "0"
  )}/${module.exports.WG_NETMARK} -o ${module.exports.WG_DEVICE} -j MASQUERADE;
...
module.exports.WG_ENABLE_ONE_TIME_LINKS =
  process.env.WG_ENABLE_ONE_TIME_LINKS || "false";
module.exports.UI_ENABLE_SORT_CLIENTS =
  process.env.UI_ENABLE_SORT_CLIENTS || "false";
module.exports.WG_ENABLE_EXPIRES_TIME =
